PREFIXES_RAW = "dozmarbinwansamlitsighidfidlissogdirwacsabwissib" + \
...
SUFFIXES_RAW = "zodnecbudwessevpersutletfulpensytdurwepserwylsun" + \
...
PREFIXES = [PREFIXES_RAW[3*ii:3*ii + 3] for ii in range(256)]
SUFFIXES = [SUFFIXES_RAW[3*ii:3*ii + 3] for ii in range(256)]
